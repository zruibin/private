...
<!--BEGIN_DATA
{
    "create_date": "2023-07-03 12:23", 
    "modify_date": "2023-07-03 12:23", 
    "is_top": "0", 
    "summary": "xmake源码架构剖析", 
    "tags": "工具", 
    "file_name": "xmake源码架构剖析.md"
}
END_DATA-->

#### <p>原文出处：<a href='https://tboox.org/cn/2017/09/28/xmake-sourcecode-arch/' target='blank'>xmake源码架构剖析</a></p>

本文主要介绍下[xmake](https://github.com/xmake-io/xmake)的整体架构设计，以及源码结构的布局和模块划分。 如果你想深度使用xmake，开发xmake插件、工程自定义脚本或者想为xmake贡献一些代码和特性，可以通过此本的介绍，对xmake项目整体有个大概的了解。，

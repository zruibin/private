...
<!--BEGIN_DATA
{
    "create_date": "2020-12-01 09:24", 
    "modify_date": "2020-12-01 09:24", 
    "is_top": "0", 
    "summary": "Linux内核中双向链表的经典实现", 
    "tags": "C/C++、Linux、数据结构、算法", 
    "file_name": "Linux内核中双向链表的经典实现.md"
}
END_DATA-->

#### <p>原文出处：<a href='https://www.cnblogs.com/skywang12345/p/3562146.html' target='blank'>Linux内核中双向链表的经典实现</a></p>

前面一章"[介绍双向链表并给出了C/C++/Java三种实现](http://www.cnblogs.com/skywang12345/p/3561803.html)"，本章继续对双向链表进行探讨，介绍的内容是Linux内核中双向链表的经典实现和用法。其中，也会涉及到Linux内核中非常常用的两个经典宏定义offsetof和container_of。内容包括：  

...
<!--BEGIN_DATA
{
    "create_date": "2020-02-09 20:15", 
    "modify_date": "2020-02-09 20:15", 
    "is_top": "0", 
    "summary": "SRT: 开源的视频传输协议<br>SRT技术到底是什么？<br>SRT协议解析", 
    "tags": "网络、C/C++、WebRTC", 
    "file_name": "SRT开源的视频传输协议.md"
}
END_DATA-->

####<p>原文出处：<a href='https://cloud.tencent.com/developer/article/1372291' target='blank'>SRT: 开源的视频传输协议</a></p>
...
####<p>原文出处：<a href='https://mp.weixin.qq.com/s?__biz=MzI5NDE1NjMyMA==&mid=2651193776&idx=1&sn=2a2ad137867f7dc27ff1fd0aa0f0177c&chksm=f79580ffc0e209e9bd1d89b1282663d5d07ffdc468f1acf479c892d1771e28e3a8ffa7ceddd7&scene=21#wechat_redirect' target='blank'>知否知否 SRT技术到底是什么？</a></p>
...
<section style="width: 100%;margin-right: auto;margin-left: auto;" data-width="100%"><section style="width: 100%;text-align: left;" data-width="100%"><section style="width: 100%;border-width: 1px;border-style: solid;border-color: rgb(140, 140, 140);display: -webkit-flex;justify-content: center;box-sizing: border-box;" data-width="100%"><section style="width: auto;border-right: 1px solid rgb(140, 140, 140);box-sizing: border-box;"><section style="font-size: 14px;line-height: 2em;color: rgb(63, 62, 63);width: 5em;margin-right: auto;margin-left: auto;"><span style="letter-spacing: normal;"><strong>S</strong>ecure</span></section></section><section style="width:100%;" data-width="100%"><p style="font-size: 14px;text-align: justify;padding: 3px 0.5em;line-height: 1.75em;color: #3f3e3f;letter-spacing: 1px;"><span style="letter-spacing: normal;">Encrypts video streams</span></p></section></section></section><section style="width: 100%;text-align: left;" data-width="100%"><section style="width: 100%;border-right: 1px solid rgb(140, 140, 140);border-bottom: 1px solid rgb(140, 140, 140);border-left: 1px solid rgb(140, 140, 140);border-top: none;display: -webkit-flex;justify-content: center;box-sizing: border-box;" data-width="100%"><section style="width: auto;border-right: 1px solid rgb(140, 140, 140);box-sizing: border-box;"><section style="font-size: 14px;line-height: 2em;color: rgb(63, 62, 63);width: 5em;margin-right: auto;margin-left: auto;"><span style="letter-spacing: normal;"><strong>R</strong>eliable</span></section></section><section style="width:100%;" data-width="100%"><p style="font-size: 14px;text-align: justify;padding: 3px 0.5em;line-height: 1.75em;color: #3f3e3f;letter-spacing: 1px;"><span style="letter-spacing: normal;">Recovers from severe packet loss</span></p></section></section></section><section style="width: 100%;text-align: left;" data-width="100%"><section style="width: 100%;border-right: 1px solid rgb(140, 140, 140);border-bottom: 1px solid rgb(140, 140, 140);border-left: 1px solid rgb(140, 140, 140);border-top: none;display: -webkit-flex;justify-content: center;box-sizing: border-box;" data-width="100%"><section style="width: auto;border-right: 1px solid rgb(140, 140, 140);box-sizing: border-box;"><section style="font-size: 14px;line-height: 2em;color: rgb(63, 62, 63);width: 5em;margin-right: auto;margin-left: auto;"><span style="letter-spacing: normal;"><strong>T</strong>ransport</span></section></section><section style="width:100%;" data-width="100%"><p style="font-size: 14px;text-align: justify;padding: 3px 0.5em;line-height: 1.75em;color: #3f3e3f;letter-spacing: 1px;"><span style="letter-spacing: normal;">Dynamically adapts to changing network conditions</span></p></section></section></section></section>

_协议的特点正如其名：通过加密保证传输内容的安全；在严重丢包的情况下可靠地恢复数据流；动态适应时刻变化地网络情况传输数据。_
...
![](./image/20200209-202025-5.webp)

_点对点单向视频传输_

![](./image/20200209-202025-6.webp)

_点对点双向视频互动_

>注：
>
>HDE-650S：高骏公司自主研发的SRT互联网传输编码器，支持4:2:2编码；
>HDD-461：高骏公司自主研发的SRT互联网传输解码器；
>两台设备搭配使用最低支持40ms超低编解码延时。
...
####<p>原文出处：<a href='https://mp.weixin.qq.com/s/3kyRZiqpfQ_CihMAAU7UmA' target='blank'>SRT协议解析</a></p>
...
![](./image/20200209-202025-10.webp)

_数据包传输时没有纠错机制_
_图片来自SRT Alliance白皮书《Haivision SRT Open Source White Paper》_
...
![](./image/20200209-202025-13.webp)

_SRT连接中的双向UDP流_

>注：
>
>SRT源设备发送的UDP流包含数据业务流和SRT控制信息；
>SRT目标设备接收源设备发来的UDP流，同时回复相应的SRT控制信息。
...
![](./image/20200209-202025-14.webp)

_SRT源设备发起建立SRT连接的过程_
...
③  两端的防火墙都要允许双向UDP传输；
④  两端的防火墙都要配置端口转发（NAT），允许编码器和解码器之间的数据流传输；

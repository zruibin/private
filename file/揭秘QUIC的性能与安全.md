...
<!--BEGIN_DATA
{
    "create_date": "2020-12-21 11:30", 
    "modify_date": "2020-12-21 11:30", 
    "is_top": "0", 
    "summary": "揭秘QUIC的性能与安全", 
    "tags": "网络", 
    "file_name": "揭秘QUIC的性能与安全.md"
}
END_DATA-->

#### <p>原文出处：<a href='https://mp.weixin.qq.com/s/X647em26p5Fz8ka1lkuKgg' target='blank'>揭秘QUIC的性能与安全</a></p>
...
5.客户端收到服务端发送的服务端临时公钥和使用K2加密的应用数据后会再次使用DH算法把服务端的临时公钥和客户端原来的临时私钥重新生成K2解密数据，并且从此以
后使用K2进行数据层的加解密
...
![](./image/20201221-113030-11.png)

由于握手的不对称性，还可以造成放大攻击：

![](./image/20201221-113030-12.png)

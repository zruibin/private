<!--BEGIN_DATA
{
    "create_date": "2016-01-25 13:34", 
    "modify_date": "2016-01-25 13:34", 
    "is_top": "0", 
    "summary": "关于Python的面试题", 
    "tags": "Python", 
    "file_name": "关于Python的面试题.md"
}
END_DATA-->

<!-- markdown-toc start - Don't edit this section. Run M-x markdown-toc-generate-toc again -->

原地址：[https://github.com/taizilongxu/interview_python](https://github.com/taizilongxu/interview_python)

python设计模式:[https://github.com/faif/python-patterns](https://github.com/faif/python-patterns)

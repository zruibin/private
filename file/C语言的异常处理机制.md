...
<!--BEGIN_DATA
{
    "create_date": "2016-07-22 10:15", 
    "modify_date": "2016-07-22 10:15", 
    "is_top": "0", 
    "summary": "C语言的异常处理机制", 
    "tags": "C/C++", 
    "file_name": "C语言的异常处理机制.md"
}
END_DATA-->

####<p>原文出处：<a href='http://blog.csdn.net/hello_wyq/article/details/826312' target='blank'>C语言中一种更优雅的异常处理机制</a></p>
...
* 在C++程序中，小心对setjmp和longjmp的使用，应为setjmp和longjmp并不能很好地支持C++中面向对象的语义。因此在C++程序中，使用C++提供的异常处理机制将会更加安全。  把setjmp和longjmp组合起来，原来它这么厉害！  
...
####<p>原文出处：<a href='http://blog.csdn.net/hello_wyq/article/details/804040' target='blank'>全面了解setjmp与longjmp的使用</a></p>

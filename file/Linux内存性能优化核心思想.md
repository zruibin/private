...
<!--BEGIN_DATA
{
    "create_date": "2021-11-05 21:00", 
    "modify_date": "2021-11-05 21:00", 
    "is_top": "0", 
    "summary": "Linux内存性能优化核心思想", 
    "tags": "系统、数据结构", 
    "file_name": "Linux内存性能优化核心思想.md"
}
END_DATA-->

#### <p>原文出处：<a href='https://mp.weixin.qq.com/s/p0FdVe9U61EX6ykFzmh5Gw' target='blank'>Linux内存性能优化核心思想</a></p>
...
![](./image/20211105-210000-6.png)

其行为如下图所示：

![](./image/20211105-210000-7.png)

## 2个场景

对于常规的对象分配过程，下图展示了其细节：

![](./image/20211105-210000-8.png)

事实上，对于多个CPU共享一个page(s)的情况，还可以有另一种玩法，如下图所示：

![](./image/20211105-210000-9.png)

...
<!--BEGIN_DATA
{
    "create_date": "2021-12-10 21:00", 
    "modify_date": "2021-12-10 21:00", 
    "is_top": "0", 
    "summary": "diff算法深入一下", 
    "tags": "Web、算法", 
    "file_name": "diff算法深入一下.md"
}
END_DATA-->

#### <p>原文出处：<a href='https://mp.weixin.qq.com/s/oRGGoObk8cdSNQ8Sy1EgCA' target='blank'>diff算法深入一下</a></p>
...
很多时候手工优化 dom 确实会比 virtual dom 效率高，对于比较简单的 dom结构用手工优化没有问题，但当页面结构很庞大，结构很复杂时，手工优化会花去大量时间，而且可维护性也不高，不能保证每个人都有手工优化的能力。至此，virtual dom 的解决方案应运而生。
...
可以看一下 vue3.x 的[源码](https://github.com/vuejs/vue/blob/8a219e3d4cfc580bbb3420344600801bd9473390/src/core/vdom/patch.js)
...
[init 函数的地址](https://github.com/snabbdom/snabbdom/blob/27e9c4d5dca62b6dabf9ac23efb95f1b6045b2df/src/init.ts#L63)
...
[源码](https://github.com/vuejs/vue/blob/8a219e3d4cfc580bbb3420344600801bd9473390/src/core/vdom/patch.js#L35)
...
[源码](https://github.com/vuejs/vue/blob/8a219e3d4cfc580bbb3420344600801bd9473390/src/core/vdom/patch.js#L404)
